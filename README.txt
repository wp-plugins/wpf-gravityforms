...
[Submit feature requests or support questions to the plugin forum](https://wordpress.org/support/plugin/wpf-gravityforms) or at [wpFortify](https://wpfortify.com) 

== Screenshots ==
1. Gravity Forms main setting screen
2. Forms setting screen
3. wpFortify access keys
